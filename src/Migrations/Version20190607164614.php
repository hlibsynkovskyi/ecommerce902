 ...
 */
final class Version20190607164614 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category_attribute ADD CONSTRAINT FK_3D1A3DCBB6E62EFA FOREIGN KEY (attribute_id) REFERENCES attribute (id) ON DELETE CASCADE');
    }
